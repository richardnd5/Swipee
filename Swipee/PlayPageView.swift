...
class PlayPageView: UIView {
    ...
    func scaleUpAndDownSlotPosition(position: Double){
        ...
        for view in positionStackView.arrangedSubviews {
            if view.tag == sequencerInt {
                view.scaleTo(scaleTo: 1.2, time: 0.3, {
    ...
    func changeColorOfBorders(){
        topView.changeBackgroundColorGraduallyTo(randomColor(), time: 0.9)
        leftView.changeBackgroundColorGraduallyTo(randomColor(), time: 0.9)
        rightView.changeBackgroundColorGraduallyTo(randomColor(), time: 0.9)
        bottomView.changeBackgroundColorGraduallyTo(randomColor(), time: 0.9)
    }
